...
MEMBER_SCRIPTS = [
    ...
    ("sapporo-city", "scripts/councils/sapporo_city.py"),
    ("sendai-city", "scripts/councils/sendai_city.py"),
    ("saitama-city", "scripts/councils/saitama_city.py"),
    ("chiba-city", "scripts/councils/chiba_city.py"),
    ("yokohama-city", "scripts/councils/yokohama_city.py"),
    ("kawasaki-city", "scripts/councils/kawasaki_city.py"),
    ("sagamihara-city", "scripts/councils/sagamihara_city.py"),
    ("niigata-city", "scripts/councils/niigata_city.py"),
    ("shizuoka-city", "scripts/councils/shizuoka_city.py"),
    ("hamamatsu-city", "scripts/councils/hamamatsu_city.py"),
    ("nagoya-city", "scripts/councils/nagoya_city.py"),
    ("kyoto-city", "scripts/councils/kyoto_city.py"),
    ("osaka-city", "scripts/councils/osaka_city.py"),
    ("sakai-city", "scripts/councils/sakai_city.py"),
    ("kobe-city", "scripts/councils/kobe_city.py"),
    ("okayama-city", "scripts/councils/okayama_city.py"),
    ("hiroshima-city", "scripts/councils/hiroshima_city.py"),
